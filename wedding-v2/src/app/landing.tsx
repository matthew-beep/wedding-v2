      ...
      <section ref={ref} className="lg:h-[200vh] h-auto min-h-[200vh] w-full relative">
        <div className="bg-[#f5f5f5] flex flex-col sm:flex-row sticky top-0 h-screen overflow-y-hidden lg:overflow-x-hidden">
          <div className="lg:w-1/2 w-full h-1/2 lg:h-full p-5">
            <div className="w-full h-full flex flex-col items-center justify-center border-2 gap-3 border-black">
              <h3 className="font-canto text-xl text-black">
                Save The Date              
              </h3>
              <div className="flex flex-col items-center justify-center gap-2 font-semibold">
                <h3 className="font-canto text-5xl text-black">
                  29th August, 2025             
                </h3>
                <hr className='h-1 border-black w-9/12'/>
              </div>
              <h3 className="font-canto text-xl text-black">
                Rock Creek Gardens             
              </h3>
